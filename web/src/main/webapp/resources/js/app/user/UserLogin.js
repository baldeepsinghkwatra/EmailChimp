...
//                'transform: translate(-50%, -50%);" onclick="EmailChimp.loadComponent(\'user/UserRegistration\')" >New User? Register</button>';
    },
    getLoginForm: function () {
        return {
            name: 'userLogin',
            header: 'Login',
            style: 'width: 450px;height:180px;left: 30%;top: 25%;',
            url: 'checkLogin',
            fields: [

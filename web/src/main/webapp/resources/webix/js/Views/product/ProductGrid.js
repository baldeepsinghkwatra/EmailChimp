...
define(['Models/ProductModal'],function (productModal) {
    ...
    var productGrid = {
        ...
        columns: [
            ...
            {id: "code", minWidth: 80, fillspace: 1},
            {id: "name", minWidth: 120, fillspace: 2, editor: "text"},
            {id: "categoryName", minWidth: 120, fillspace: 2, editor: "select", template: "<div class='category#category#'>#categoryName#</div>"},
    ...
    return {
        ...
        type: 'clean',
        rows: [
            {height: 49, id: "title", css: "title", template: "<div class='header'>#title# ( #details# )</div>", data: {details: "all product", title: "Product"}},
            {
                type: "space",
                rows: [
                    {
                        ...
                        cols: [
                            ...
                            {view: "button", type: "iconButton", icon: "refresh", width: 100, label: "Refresh", click: function () {
                                    ...
                                    webix.delay(function () {
                                        grid.parse(productModal.getAll);
                                        grid.hideProgress();
                                    }, null, null, 300);
                                }},
                            {},
